...
- A Multi-Agent Customer Intelligence Platform that processes customer queries using four specialized AI agents sharing a single LLM backend.
...
```bash
git clone https://github.com/TirumalaSrividya/multi-agent-customer-intelligence-platform.git
cd multi-agent-customer-intelligence-platform
```
